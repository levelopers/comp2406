...
if (process.argv.length < 4) {
    console.error('Not enough parameters given. Try this: ' +
                  '"node words-async.js <input-file> <output-file>"'); 
    process.exit(1);
}
...
var finished = function(err, written, string) {
    console.log("Finished!");
}

var parseFile = function(err, rawContents) {
    var wordSep = /\W/;
    ...
    fs.writeFile(outputFilename, outputContents.join('\n'), finished);
}

fs.readFile(inputFilename, 'utf-8', parseFile);
